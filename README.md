...
Данный проект представляет собой симуляционную модель гематологического анализатора URIT-5380, разработанную с использованием Kotlin-библиотеки для дискретно-событийного моделирования **Kalasim**. Результаты симуляции визуализируются с помощью мультиплатформенной библиотеки **Plotly.kt**.
